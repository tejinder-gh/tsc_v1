...
| :--- | :--- | :--- | :--- |
| `/` | [`app/(marketing)/page.tsx`](file:///Users/tejindersingh/dev/projects/TheSkillCorner/app/(marketing)/page.tsx) | Public | **Homepage**: Editorial Studio narrative (Global Masthead, 01 System Studies, 02 Intent Router & Live Observed System, 03 Curated Explore, 04 How We Decide, 05 Founder POV, 06 Open Prompt, Minimal Footer). |
...
| `/api/newsletter/subscribe` | `POST` | [`app/api/newsletter/subscribe/route.ts`](file:///Users/tejindersingh/dev/projects/TheSkillCorner/app/api/newsletter/subscribe/route.ts) | Rate limited (10 req/min) + Honeypot drop + Zod validation + 32KB payload limit | Registers newsletter subscriptions, validates publication slugs, throttles abusive submissions with 429 Retry-After, logs masked PII audit events, forwards to CRM webhook when set, and returns early-subscriber waitlist status. |
