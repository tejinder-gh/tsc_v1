...
export function AbstractVisual({ variant, className = "", delay = "450ms" }: AbstractVisualProps) {
  ...
  if (variant === "home") {
    content = (
      <div className="relative w-full max-w-md aspect-square">
        {/* Connecting lines */}
        <svg className="absolute inset-0 h-full w-full stroke-slate-200" fill="none" viewBox="0 0 400 400">
          <path d="M 100 100 C 100 250, 300 150, 300 300" strokeWidth="2" strokeDasharray="4 4" className="animate-[pulse_4s_ease-in-out_infinite] stroke-ledger/30" />
          <path d="M 300 100 C 300 250, 100 150, 100 300" strokeWidth="2" strokeDasharray="4 4" className="animate-[pulse_4s_ease-in-out_infinite_1s] stroke-accent/30" />
        </svg>
    ...
    // Hub and spoke for services
    content = (
      <div className="relative w-full max-w-md aspect-square">
        <svg className="absolute inset-0 h-full w-full stroke-slate-200" fill="none" viewBox="0 0 400 400">
          <circle cx="200" cy="200" r="120" strokeWidth="1" strokeDasharray="4 4" className="animate-[spin_20s_linear_infinite] stroke-ledger/20 origin-center" />
          <path d="M 200 200 L 200 80" strokeWidth="2" strokeDasharray="4 4" className="animate-[pulse_3s_ease-in-out_infinite] stroke-ledger/40" />
          <path d="M 200 200 L 304 260" strokeWidth="2" strokeDasharray="4 4" className="animate-[pulse_3s_ease-in-out_infinite_1s] stroke-accent/40" />
          <path d="M 200 200 L 96 260" strokeWidth="2" strokeDasharray="4 4" className="animate-[pulse_3s_ease-in-out_infinite_2s] stroke-ledger/40" />
        </svg>
    ...
    // Branching tree for industries
    content = (
      <div className="relative w-full max-w-md aspect-square">
        <svg className="absolute inset-0 h-full w-full stroke-slate-200" fill="none" viewBox="0 0 400 400">
          <path d="M 50 200 C 150 200, 150 80, 250 80" strokeWidth="2" strokeDasharray="4 4" className="animate-[pulse_3s_ease-in-out_infinite] stroke-ledger/30" />
          <path d="M 50 200 C 150 200, 150 200, 250 200" strokeWidth="2" strokeDasharray="4 4" className="animate-[pulse_3s_ease-in-out_infinite_0.5s] stroke-accent/40" />
          <path d="M 50 200 C 150 200, 150 320, 250 320" strokeWidth="2" strokeDasharray="4 4" className="animate-[pulse_3s_ease-in-out_infinite_1s] stroke-ledger/30" />
        </svg>
    ...
    content = (
      <div className="relative w-full max-w-sm aspect-square">
        <svg className="absolute inset-0 h-full w-full stroke-slate-200" fill="none" viewBox="0 0 400 400">
          <circle cx="200" cy="200" r="160" strokeWidth="1" strokeDasharray="2 6" className="animate-[spin_30s_linear_infinite] stroke-ledger/30 origin-center" />
          <circle cx="200" cy="200" r="100" strokeWidth="1" strokeDasharray="4 4" className="animate-[spin_20s_linear_infinite_reverse] stroke-accent/40 origin-center" />
        </svg>
  ...
  } else if (variant === "contact" || variant === "book") {
    // Linear pipeline / path
    content = (
      <div className="relative w-full max-w-md aspect-[4/3] flex items-center">
        <svg className="absolute inset-0 h-full w-full stroke-slate-200" fill="none" viewBox="0 0 400 300">
          <path d="M 50 150 L 350 150" strokeWidth="2" strokeDasharray="4 4" className="animate-[pulse_3s_ease-in-out_infinite] stroke-ledger/40" />
        </svg>
    ...
    // Checklist pattern (layered cards or nodes)
    content = (
      <div className="relative w-full max-w-sm aspect-square">
        <div className="absolute top-[20%] left-[20%] flex h-24 w-48 -translate-x-1/2 -translate-y-1/2 items-center rounded-2xl border border-white/40 bg-white/40 shadow-sm backdrop-blur-md p-4 rotate-[-12deg] transform transition-transform">
        ...
        <div className="absolute top-[80%] left-[80%] flex h-24 w-48 -translate-x-1/2 -translate-y-1/2 items-center rounded-2xl border border-white/40 bg-white/40 shadow-sm backdrop-blur-md p-4 rotate-[15deg]">
