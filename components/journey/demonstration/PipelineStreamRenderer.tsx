...
interface PipelineStreamRendererProps {
  scenario: DemonstrationScenario;
  onStarted?: () => void;
  onCompleted?: () => void;
}

export function PipelineStreamRenderer({
  scenario,
  onStarted,
  onCompleted,
}: PipelineStreamRendererProps) {
